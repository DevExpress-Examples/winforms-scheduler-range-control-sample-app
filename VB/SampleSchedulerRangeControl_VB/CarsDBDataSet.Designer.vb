    ...
    Partial Public Class CarSchedulingTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[CarScheduling] ([UserId], [Status], [Subject], [Description], "& _ 
                ...
                " @PercentComplete, @CarIDs);"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, UserId, Status, Subject, Description, La"& _ 
                "bel, StartTime, EndTime, Location, AllDay, EventType, RecurrenceInfo, ReminderIn"& _ 
                "fo, Price, ContactInfo, PercentComplete, CarIDs FROM CarScheduling WHERE (ID = S"& _ 
                "COPE_IDENTITY())"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[CarScheduling] SET [UserId] = @UserId, [Status] = @Status, [Subject"& _ 
                ...
                "e] = @Original_EventType)) AND ((@IsNull_Price = 1 AND [Price] IS NULL) OR ([Pri"& _ 
                "ce] = @Original_Price)) AND ((@IsNull_PercentComplete = 1 AND [PercentComplete] "& _ 
                "IS NULL) OR ([PercentComplete] = @Original_PercentComplete)));"&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT ID, UserId"& _ 
                ", Status, Subject, Description, Label, StartTime, EndTime, Location, AllDay, Eve"& _ 
                "ntType, RecurrenceInfo, ReminderInfo, Price, ContactInfo, PercentComplete, CarID"& _ 
                "s FROM CarScheduling WHERE (ID = @ID)"
